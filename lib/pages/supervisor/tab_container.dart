...
import 'package:acoman/pages/supervisor/home.dart';
import 'package:acoman/pages/supervisor/scan_documents.dart';
import 'package:acoman/pages/supervisor/settings.dart';
...
class TabContainerSupervisorPage extends StatefulWidget {
  const TabContainerSupervisorPage({super.key});

  @override
  State<TabContainerSupervisorPage> createState() =>
      _TabContainerSupervisorPageState();
}

class _TabContainerSupervisorPageState
    extends State<TabContainerSupervisorPage> {
        ...
        child: Scaffold(
            ...
            body: TabBarView(
              ...
              children: <Widget>[
                ...
                const ScanDocummentsPage(),
                const SettingsSupervisorPage(),
              ],
            ),
