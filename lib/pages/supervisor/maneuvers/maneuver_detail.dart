...
class ManeuverDetailPage extends StatelessWidget {
  final Maneuver maneuver;

  const ManeuverDetailPage({super.key, required this.maneuver});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Maniobra #${maneuver.id.toString().padLeft(6, '0')}', style: TextStyle(color: Colors.white, fontSize: 20.0),),
        actions: [
          IconButton(
  ...
  Widget _buildIndicationsSection() {
    return Column(
      ...
      children: [
        ...
        _buildBulletPoints("contraindications" ?? 'No hay contraindicaciones específicas'),
      ],
    );
  }
