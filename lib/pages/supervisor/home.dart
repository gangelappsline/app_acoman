...
import 'package:acoman/pages/supervisor/maneuvers/maneuver_details_freeze.dart';
    ...
    switch (maneuver.type) {
      case "frio":
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                ManeuverDetailFreezeSupervisorPage(maneuver: maneuver),
          ),
        );
        break;
      case "seco":
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                ManeuverDetailDrySupervisorPage(maneuver: maneuver),
          ),
        );
        break;
      case "marindustrias":
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                ManeuverDetailMarSupervisorPage(maneuver: maneuver),
          ),
        );
        break;
        default:
